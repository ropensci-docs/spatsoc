...
`direction` column from `direction_step` and a `group` column from
`group_pts`.
...
`direction_polarization` returns the input `DT` appended with a
`polarization` column representing the direction polarization of all
individuals in each spatiotemporal group.

The direction polarization is calculated using
[`CircStats::r.test()`](https://rdrr.io/pkg/CircStats/man/r.test.html)
which expects units of radians.

A message is returned when the `polarization` columns already exists in
...
column is expected in units of radians and the polarization is
calculated with
[`CircStats::r.test()`](https://rdrr.io/pkg/CircStats/man/r.test.html).
...
#> 14296:      J 700610.3 5509269 2017-02-28 20:00:48          1       0      1395
#> 14297:      J 700744.0 5508782 2017-02-28 22:00:39          1       0      1396
#>        group         direction polarization                 geometry
#>        <int>           <units>        <num>              <sfc_POINT>
#>     1:     1 -2.65649015 [rad]            1 POINT (715851.4 5505340)
#>     2:     2  2.17592086 [rad]            1 POINT (715822.8 5505289)
#>     3:     3 -1.98432277 [rad]            1 POINT (715872.9 5505252)
#>     4:     4  1.90650150 [rad]            1 POINT (715820.5 5505231)
#>     5:     5 -0.04059949 [rad]            1 POINT (715830.6 5505227)
#>    ---                                                              
#> 14293:  9899  2.10901157 [rad]            1 POINT (700616.5 5509069)
#> 14294:  9900  0.13663566 [rad]            1 POINT (700622.6 5509065)
#> 14295:  9901 -1.78096501 [rad]            1 POINT (700657.5 5509277)
#> 14296:  9902  2.84652173 [rad]            1 POINT (700610.3 5509269)
#> 14297:  9903          NA [rad]           NA   POINT (700744 5508782)
...
#> 14296:      J 700610.3 5509269 2017-02-28 20:00:48          1       0      1395
#> 14297:      J 700744.0 5508782 2017-02-28 22:00:39          1       0      1396
#>                direction polarization                 geometry group
#>                  <units>        <num>              <sfc_POINT> <int>
#>     1: -2.65649015 [rad]            1 POINT (715851.4 5505340)     1
#>     2:  2.17592086 [rad]            1 POINT (715822.8 5505289)     2
#>     3: -1.98432277 [rad]            1 POINT (715872.9 5505252)     3
#>     4:  1.90650150 [rad]            1 POINT (715820.5 5505231)     4
#>     5: -0.04059949 [rad]            1 POINT (715830.6 5505227)     5
#>    ---                                                              
#> 14293:  2.10901157 [rad]            1 POINT (700616.5 5509069) 13882
#> 14294:  0.13663566 [rad]            1 POINT (700622.6 5509065) 13883
#> 14295: -1.78096501 [rad]            1 POINT (700657.5 5509277) 13884
#> 14296:  2.84652173 [rad]            1 POINT (700610.3 5509269) 13885
#> 14297:          NA [rad]           NA   POINT (700744 5508782) 13886
...
#> 14296:      J 700610.3 5509269 2017-02-28 20:00:48          1       0      1395
#> 14297:      J 700744.0 5508782 2017-02-28 22:00:39          1       0      1396
#>        polarization                 geometry group         direction
#>               <num>              <sfc_POINT> <int>           <units>
#>     1:            1 POINT (715851.4 5505340)     1 -2.65649015 [rad]
#>     2:            1 POINT (715822.8 5505289)     2  2.17592086 [rad]
#>     3:            1 POINT (715872.9 5505252)     3 -1.98432277 [rad]
#>     4:            1 POINT (715820.5 5505231)     4  1.90650150 [rad]
#>     5:            1 POINT (715830.6 5505227)     5 -0.04059949 [rad]
#>    ---                                                              
#> 14293:            1 POINT (700616.5 5509069) 13882  2.10901157 [rad]
#> 14294:            1 POINT (700622.6 5509065) 13883  0.13663566 [rad]
#> 14295:            1 POINT (700657.5 5509277) 13884 -1.78096501 [rad]
#> 14296:            1 POINT (700610.3 5509269) 13885  2.84652173 [rad]
#> 14297:           NA   POINT (700744 5508782) 13886          NA [rad]
direction_polarization(DT)
#> polarization column will be overwritten by this function
#>            ID        X       Y            datetime population minutes timegroup
#>        <char>    <num>   <num>              <POSc>      <int>   <int>     <int>
#>     1:      A 715851.4 5505340 2016-11-01 00:00:54          1       0         1
#>     2:      A 715822.8 5505289 2016-11-01 02:01:22          1       0         2
...
#> 14296:      J 700610.3 5509269 2017-02-28 20:00:48          1       0      1395
#> 14297:      J 700744.0 5508782 2017-02-28 22:00:39          1       0      1396
#>                        geometry group         direction polarization
#>                     <sfc_POINT> <int>           <units>        <num>
#>     1: POINT (715851.4 5505340)     1 -2.65649015 [rad]            1
#>     2: POINT (715822.8 5505289)     2  2.17592086 [rad]            1
#>     3: POINT (715872.9 5505252)     3 -1.98432277 [rad]            1
#>     4: POINT (715820.5 5505231)     4  1.90650150 [rad]            1
#>     5: POINT (715830.6 5505227)     5 -0.04059949 [rad]            1
#>    ---                                                              
#> 14293: POINT (700616.5 5509069) 13882  2.10901157 [rad]            1
#> 14294: POINT (700622.6 5509065) 13883  0.13663566 [rad]            1
#> 14295: POINT (700657.5 5509277) 13884 -1.78096501 [rad]            1
#> 14296: POINT (700610.3 5509269) 13885  2.84652173 [rad]            1
#> 14297:   POINT (700744 5508782) 13886          NA [rad]           NA
```
